		...
		while(canWaiter){
				...
				try {
					...
					System.out.println("dd========================"+dd);
					 window.txtMsg.append("dd========================"+dd+"\n");
					String yuan=datatest.test.hashcode(str4);
					System.out.println("yuan0========================"+yuan);
					 window.txtMsg.append("yuan0========================"+yuan+")"+"\n");
					if(yuan.equals(dd)) {
						window.txtMsg.append("比对成功"+"\n");
